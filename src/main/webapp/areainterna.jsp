  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark" aria-label="Main navigation">
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="PessoaController">Usuários</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="LogoutController">Logout</a>
          </li>
        <!-- <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle show" href="#" data-bs-toggle="dropdown" aria-expanded="true">Settings</a>
...
<main class="container">
  <div class="d-flex align-items-center p-3 my-3 text-Black bg-purple rounded shadow-sm">
    <img class="me-3" src="img/login.png" alt="" width="48" height="38">
    <div class="lh-1">
      <h1 class="h6 mb-0 text-black lh-1">
      <%=usuario.toString()%>
      </h1>
      <small>Logado desde <%=data.toString()%></small>
    </div>
  </div>
